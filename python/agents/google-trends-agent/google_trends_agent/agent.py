...
GOOGLE_MODEL_NAME_AGENT = os.getenv("GOOGLE_MODEL_NAME_AGENT", "gemini-2.5-pro")
GOOGLE_MODEL_NAME_TOOL = os.getenv("GOOGLE_MODEL_NAME_TOOL", "gemini-2.5-flash")
