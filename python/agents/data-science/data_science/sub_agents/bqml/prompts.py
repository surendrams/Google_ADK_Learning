  ...
  """
    ...
    <TASK>
        ...
        **BQ ML SYNTAX:**
        ...
        CREATE OR REPLACE GOOGLE_MODEL_NAME `your_project_id.your_dataset_id.sample_model`
        ...
        **QUERY DETAILS**
        ...
        The CREATE GOOGLE_MODEL_NAME statement creates the model and then trains the model using the data retrieved by your query's SELECT statement.
        ...
        eval_metric
        FROM
            ML.TRAINING_INFO(GOOGLE_MODEL_NAME `my_dataset.my_model`)
        ORDER BY
        iteration;
        </EXAMPLE: RETRIEVE TRAINING INFO>"""
