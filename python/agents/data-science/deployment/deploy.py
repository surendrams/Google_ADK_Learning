...
def main(argv: list[str]) -> None:  # pylint: disable=unused-argument
    ...
    env_var_keys = [
        "ROOT_AGENT_GOOGLE_MODEL_NAME",
        "ANALYTICS_AGENT_GOOGLE_MODEL_NAME",
        "BASELINE_NL2SQL_GOOGLE_MODEL_NAME",
        "BIGQUERY_AGENT_GOOGLE_MODEL_NAME",
        "BQML_AGENT_GOOGLE_MODEL_NAME",
        "CHASE_NL2SQL_GOOGLE_MODEL_NAME",
        "BQ_DATASET_ID",
        "BQ_DATA_PROJECT_ID",
