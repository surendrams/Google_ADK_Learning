    ...
    if not isinstance(
        ...
        return EvalResult(
            result.Error(
                CaMeLException(
                    TypeError(
                        f"'{sequence.raw_type}' object does not support item assignment"
                    ),
                    (subscript,),
                    (sequence,),
                )
...
def _eval_call(
    ...
    if not isinstance(
        evaled_fn,
        camel_value.CaMeLBuiltin | camel_value.CaMeLClass,
    ...
    for field in valuebody:
        ...
        if field.value is not None:
            return result.Error(
                CaMeLException(
                    SyntaxError(
                        "cannot specify default values for fields in class definitions."
                    ),
                    (field,),
                    (),
                )
