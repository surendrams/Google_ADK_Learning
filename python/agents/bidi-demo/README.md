...
DEMO_AGENT_GOOGLE_MODEL_NAME=gemini-2.5-flash-native-audio-preview-09-2025
```
...
agent = Agent(
    ...
    model=os.getenv("DEMO_AGENT_GOOGLE_MODEL_NAME", "gemini-2.5-flash-native-audio-preview-09-2025"),
    tools=[google_search],
...
Set the model via `DEMO_AGENT_GOOGLE_MODEL_NAME` in `.env` or modify `app/google_search_agent/agent.py`.
