...
VIDEO_GOOGLE_MODEL_NAME = "veo-3.0-generate-preview"
VIDEO_GOOGLE_MODEL_NAME_LOCATION = "us-central1"
DESCRIPTION = (
...
client = genai.Client(
    ...
    location=VIDEO_GOOGLE_MODEL_NAME_LOCATION,
)
...
try:
    ...
    logger.info(f"✅ Agent '{video_agent.name}' created using model '{GOOGLE_MODEL_NAME}'.")
except Exception as e:
    logger.error(
