...
IMAGE_GEN_GOOGLE_MODEL_NAME_GEMINI = "gemini-2.5-flash-image-preview"
IMAGE_GEN_GOOGLE_MODEL_NAME_IMAGEN = "imagen-4.0-generate-001"
STORYLINE_GOOGLE_MODEL_NAME = "gemini-2.5-pro"
MAX_RETRIES = 3
...
async def _call_gemini_image_api(
    ...
    try:
        response = await client.aio.models.generate_content(
            model=IMAGE_GEN_GOOGLE_MODEL_NAME_GEMINI,
            contents=contents,
...
async def _call_imagen_api(prompt: str, filename_prefix: str) -> Dict[str, Any]:
    ...
    """
    try:
        model = ImageGenerationModel.from_pretrained(IMAGE_GEN_GOOGLE_MODEL_NAME_IMAGEN)
