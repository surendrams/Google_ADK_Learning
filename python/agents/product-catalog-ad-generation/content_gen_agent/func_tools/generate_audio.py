...
TTS_GOOGLE_MODEL_NAME_NAME = "gemini-2.5-flash-preview-tts"
TTS_VOICE_NAME = "Schedar"
LYRIA_GOOGLE_MODEL_NAME_NAME = "lyria-002"
...
async def generate_audio(
    ...
    endpoint = (
        ...
        f"/locations/us-central1/publishers/google/models/{LYRIA_GOOGLE_MODEL_NAME_NAME}:predict"
    )
...
async def generate_voiceover(
    ...
    model_name: str = TTS_GOOGLE_MODEL_NAME_NAME,
